      ...
      <div className="md:pt-40 mobile:px-2 mobile:py-20">
        <div className="inline tracking-wide text-center md:w-6 w-full md:flex-1">
          ...
          <span className="inline-block w-full">
            <p className=" mobile:text-wrap p-4 mobile-landscape:p-0 text-xs md:text-lg text-nowrap inline-block overflow-hidden whitespace-nowrap mobile:justify-center mobile:inline-block">
