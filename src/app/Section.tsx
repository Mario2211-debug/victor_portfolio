...
export default function PreSection(){
  return(
      ...
      <div className="contents md:container justify-between text-center">
        <div className="items-center md:justify-between mobile:px-2 mobile:py-20 md:flex ">
          ...
          <span className="text-white md:w-14 ">
            ...
            <h1 className="text-white mobile:text-5xl font-Bellefair pb-2 md:text-7xl font-bold">Software</h1>
            <h1 className="text-white mobile:text-5xl font-Bellefair pb-2 md:text-7xl font-bold"> Engineer</h1>
            <Brands/>
          </div>
      ...
      <div className=" animate-blob origin-center">
        ...
        <div className="bg-gradient-to-tl from-gray-950 from-45% via-gray-300 to-blue-950 to-55%">
      ...
      I believe in using product design as a tool to elevate human interaction with technology that scale.
            </p>
            </span>
          </div>
