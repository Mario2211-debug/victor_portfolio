  ...
  return (
    <>
      ...
      <div className="text-center mx-16 mobile:mx-6">
        ...
        <div className="flex items-center justify-center my-16 mx-3 text-white rounded-lg bg-gray-900 bg-opacity-50 mobile:mx-10">
          <div className="grid grid-cols-1 gap-4 py-10 text-justify rounded-md tablet:grid-cols-2 laptop:grid-cols-3 ">
            {posts.map((post) => (
              <div key={post._id} className="px-8 py-6 mobile:px-12">
